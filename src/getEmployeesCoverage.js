...
const funcDeLocalizar = (speciesNames) => {
  let objetosPorSpecieName = data.species.filter((element) => speciesNames.includes(element.name));
  const localizacoesDosObjs = objetosPorSpecieName.map((element) => element.location)
