...
const specie = require('../src/getSpeciesByIds');

const { employees } = data;

function getIndicatedEmployee(obj) {//Esta função retorna o objeto da pessoa colaboradora indicada no parâmetro(obj)
